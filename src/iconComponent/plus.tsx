...
const PlusCircle: React.FC<Props> = ({ size = 20, ...rest }) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Plus sign (vertical + horizontal) */}
      <G clipPath="url(#clip_plus)">
        <Path
          d="M10 4V16"
          stroke="url(#paint_vertical)"
          strokeWidth={2}
          strokeLinecap="round"
        />
        <Path
          d="M16 10H4"
          stroke="url(#paint_horizontal)"
          strokeWidth={2}
          strokeLinecap="round"
        />
      </G>
      ...
      <Defs>
        ...
        {/* Clipping area for the plus sign */}
