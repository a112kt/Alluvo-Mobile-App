...
export default function SwitchToUserScreen() {
      ...
      <View style={[styles.container, { paddingBottom: tabBarPadding }]}>
        ...
        >
          <Text style={styles.subtitle}>
            Browse the app as a customer, discover products, watch reels, and
            experience the platform from a user's perspective.
          </Text>
        </Animated.View>
